...
std::vector<int> QUANTITY_LIST = std::vector<int>({10, 15, 20, 30, 50, 100, 150, 250, 500, 750, 1000, 1500, 3000, 5000, 10000, 50000);
//std::vector<unsigned int> QUANTITY_LIST = std::vector<unsigned int>({50000, 100000, 500000, 1000000, 10000000});//, 15, 20, 30, 50, 100, 250, 500, 750, 1000});
