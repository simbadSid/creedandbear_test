...
void OrdersManager_3_sharedList_BufferedList::custom_fake_save_on_db(int order_id, unsigned int order_number)
{
    this->bufferSharedList[this->currentBufferSize] = std::pair<int, unsigned int>(order_id, order_number);
